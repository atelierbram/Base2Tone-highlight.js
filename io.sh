...
overwrite_to_file()
{
  ...
  base16-builder --scheme "db/schemes/base2tone-evening.yml" --template "db/templates/highlight.js/light.ejs" > "docs/assets/css/styles/base2tone-evening-light.css"
  base16-builder --scheme "db/schemes/base2tone-morning.yml" --template "db/templates/highlight.js/dark.ejs" > "docs/assets/css/styles/base2tone-morning-dark.css"
  ...
  base16-builder --scheme "db/schemes/base2tone-space.yml" --template "db/templates/highlight.js/light.ejs" > "docs/assets/css/styles/base2tone-space-light.css"
  ...
  base16-builder --scheme "db/schemes/base2tone-sea.yml" --template "db/templates/highlight.js/light.ejs" > "docs/assets/css/styles/base2tone-sea-light.css"
  ...
  base16-builder --scheme "db/schemes/base2tone-forest.yml" --template "db/templates/highlight.js/light.ejs" > "docs/assets/css/styles/base2tone-forest-light.css"
  ...
  base16-builder --scheme "db/schemes/base2tone-earth.yml" --template "db/templates/highlight.js/light.ejs" > "docs/assets/css/styles/base2tone-earth-light.css"
  ...
  base16-builder --scheme "db/schemes/base2tone-desert.yml" --template "db/templates/highlight.js/light.ejs" > "docs/assets/css/styles/base2tone-desert-light.css"
  ...
  base16-builder --scheme "db/schemes/base2tone-pool.yml" --template "db/templates/highlight.js/light.ejs" > "docs/assets/css/styles/base2tone-pool-light.css"
  ...
  base16-builder --scheme "db/schemes/base2tone-lake.yml" --template "db/templates/highlight.js/light.ejs" > "docs/assets/css/styles/base2tone-lake-light.css"
  ...
  base16-builder --scheme "db/schemes/base2tone-drawbridge.yml" --template "db/templates/highlight.js/light.ejs" > "docs/assets/css/styles/base2tone-drawbridge-light.css"
  ...
  base16-builder --scheme "db/schemes/base2tone-meadow.yml" --template "db/templates/highlight.js/light.ejs" > "docs/assets/css/styles/base2tone-meadow-light.css"
 }
